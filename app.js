...
function clearFocus(){
  if(state?.focus && typeof state.focus.clearLayers==="function"){
    state.focus.clearLayers();
  }
  state.active=null;
  document.querySelectorAll(".map-focus-card,.active").forEach(el=>{
    el.classList.remove("map-focus-card","active");
  });
}
